...
export default class GenericEVMConnectionResourceMock extends GenericEVMConnectionResource {
   ...
   setup(): void {
      const signer = new ethers.Wallet('0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80', new ethers.providers.JsonRpcProvider('http://localhost:8545'))
